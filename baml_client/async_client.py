...
class BamlAsyncClient:
    ...
    async def AskHeuristicQuestion(self, question: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.AskHeuristicQuestion(question=question,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="AskHeuristicQuestion", args={
                "question": question,
            })
...
class BamlStreamClient:
    ...
    def AskHeuristicQuestion(self, question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[str, str]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="AskHeuristicQuestion", args={
            "question": question,
        })
...
class BamlHttpRequestClient:
    ...
    async def AskHeuristicQuestion(self, question: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="AskHeuristicQuestion", args={
            "question": question,
        }, mode="request")
        return result
